...
TODO. NOTE: Delete ~/mail (1.7 GB), Nov 2019
...
- [Stack Exchange overview](https://emacs.stackexchange.com/questions/12927/reading-and-writing-email-with-emacs)
- [Emacs, Notmuch and Offlineimap](https://chrisdone.com/posts/emacs-mail/)
