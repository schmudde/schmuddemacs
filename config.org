...
I want to select forms and delete them in Paredit. Setting it to /C-del/ is actually a little tricky. First, I need to find the function key sequences for xterm for /C-del/: ~(define-key map "\e[3;5​~" [C-delete])~ in ~/usr/share/emacs/27.1/lisp/term~. Then set the key:

#+BEGIN_SRC emacs-lisp
(global-set-key (kbd "\e[3;5~") 'paredit-delete-region)
#+END_SRC
...
- [[https://github.com/munen/emacs.d#translations][Translations]]
