(setq elfeed-feeds
      '(("https://carnegieendowment.org/rss" real-news)
        ...
        ("https://richardgwyn.me/feed/")
        ("https://jonathangray.org/feed.xml")
        ("http://chrisblattman.com/feed/")
        ("https://lord.io/feed.xml")
        ("http://www.thinktankwatch.com/feeds/posts/default")
        ("http://www.dlederle.com/feed.xml")
        ...
        ("http://feeds2.feedburner.com/SlicingUpEyeballs")
        ("http://www.overgrownpath.com/feeds/posts/default")
        ("http://www.preservationsound.com/?feed=rss2")
        ("http://regenmag.com/feed/" music)
        ("http://audiocookbook.org/feed/")
        ("http://www.falconproductions.us/blog/index.xml")
        ("http://feeds.feedburner.com/Post-punk")
        ...
        ("https://techlearningcollective.com/feed.xml")
        ...
        ("http://self-issued.info/?feed=rss2")
        ("http://beltmag.com/feed/" chicago)
        ("https://blockclubchicago.org/feed/" chicago)
        ("http://www.aldaily.com/feed/" culture art)
        ("http://weeklysift.com/feed/" bloggers real-news)
        ("http://pedestrianobservations.wordpress.com/feed/")
        ...
        ("http://www.digicult.it/feed/")
        ("http://www.creativeapplications.net/feed/")
        ("https://artofericwayne.com/feed/")
        ("https://pluralistic.net/feed/")
        ("http://www.schneier.com/blog/index.rdf" bloggers networks comp-sci)
        ("http://tinysubversions.com/feed.xml" networks digital-art)
        ("http://redecentralize.org/blog/feed.rss" networks)
        ("https://p1k3.com/feed")
        ("https://100r.co/links/rss.xml" digital-art comp-sci)
        ...
        ("http://intertwingled.org/feed/")
        ("http://www.secretgeek.net/Rss")
        ("http://feeds.feedburner.com/TechnopolisBlog-LangdonWinner")
        ("https://medium.com/feed/decentralized-web")
        ("https://silasjelley.com/feeds/everything")
        ("https://publicinfrastructure.org/feed/")
        ("http://www.mkbergman.com/?feed=rss2")
        ("http://planetrdf.com/index.rdf")
        ("https://techlearningcollective.com/feed/events.xml" sts)
        ...
        ("http://feeds2.feedburner.com/ignant")
        ("http://www.berlinartlink.com/feed/" germany)
        ("https://berlinspectator.com/feed/" germany)
        ("http://digitalcosmonaut.com/feed/")
        ("http://www.iheartberlin.de/feed/" germany)
        ("http://www.edge.org/feed")
        ("https://feeds.feedburner.com/sciencealert-latestnews")
        ("http://brevity.wordpress.com/feed/")
        ("http://triquarterly.northwestern.edu/site-feed")
        ("https://chi.streetsblog.org/author/sharonhoyer/feed/")
        ("https://bnet.substack.com/feed/")
        ("https://blog.ignaciobrasca.com/feed.xml" friends comp-sci)
        ("https://blog.matthoran.com/index.xml" friends)
        ("http://www.nathanwolek.com/feed/" friends music)
        ("http://blog.jessitron.com/feeds/posts/default" friends comp-sci)
        ("http://modulolotus.net/feed.xml" friends)
        ("http://danielbachler.de/feed.xml" friends)
        ("https://gist.github.com/brfid.atom")
        ("http://newcitystage.com/feed/" chicago)
        ("https://compassneedleblog.wordpress.com/feed/")
        ("https://commodore.international/feed/" atari)
        ("https://acjay.com/feed/")
        ("http://seespotcode.net/feed.xml" friends clojure)
        ("http://esoteric.codes/rss" friends digital-art)
        ("http://blog.veitheller.de/feed.rss" friends comp-sci)
        ("https://blog.emma.coop/read/feed/")
        ("https://taylor.town/feed.xml" friends)
        ("http://naik.co/feed/" friends)
        ("https://joshuafinnell.com/feed/")
        ("https://www.hillelwayne.com/post/index.xml")
        ("https://southstreetdungeon.wordpress.com/feed/" friends music)
        ("http://www.meanwhilebackinpeoria.com/blog?format=rss" friends)
        ("http://artoftravelogue.blogspot.com/feeds/posts/default" friends music)
        ("http://zerolib.com/feed.xml" friends)
        ("https://schmud.de/feed.rss" friends)
        ("http://freecinemanow.blogspot.com/feeds/posts/default")
        ("https://buttondown.email/perfectsentences/rss")
        ("https://medium.com/feed/@ericcorrielstudios")
        ("https://m.signalvnoise.com/author/ryan-singer/feed/")
        ("http://mackbernie.blogspot.com/feeds/posts/default")
        ("https://missginsu.com/index.xml" friends)
        ("http://www.cs.uni.edu/~wallingf/blog/index.xml" friends comp-sci)
        ("http://feeds.feedburner.com/johnpilger")
        ("https://realalexrubi.substack.com/feed/")
        ...
        ("http://romchip.org/index.php/romchip-journal/gateway/plugin/WebFeedGatewayPlugin/atom")
        ...
        ("https://lunduke.substack.com/feed/")
        ("http://sachachua.com/blog/category/emacs/feed/" emcas)
        ("http://xenodium.com/rss.xml")
        ("https://alirezahayati.com/feed/")
        ("https://api.observablehq.com/documents/@tomlarkworthy.rss")
        ("https://gallant.dev/rss.xml")
        ("http://boffosocko.com/feed/")
        ("https://ohhelloana.blog/feed.xml")
        ("https://www.markllobrera.com/feed/feed.xml")
        ...
        ("http://screenwritingfromiowa.wordpress.com/feed/")
        ("https://draculadaily.substack.com/feed")
        ("http://www.davidbordwell.net/blog/feed/atom/")
        ("http://www.aphotoeditor.com/feed/")
        ("http://www.therestisnoise.com/atom.xml")
